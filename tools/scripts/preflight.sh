...
JP_UNITS=(
  ...
  "biz-doc-unit1|biz-doc-types|ライティング・文書作成/ビジネス文書の基本/Unit 1ビジネス文書の種類と目的"
  "biz-doc-unit2|biz-doc-prep|ライティング・文書作成/ビジネス文書の基本/UNIT2 正確・簡潔・分かりやすい文章術（PREP法）"
  "biz-doc-unit3|biz-doc-layout|ライティング・文書作成/ビジネス文書の基本/UNIT3 レイアウトと体裁の整え方"
  "biz-doc-unit4|biz-doc-internal-external|ライティング・文書作成/ビジネス文書の基本/UNIT4 社内文書・社外文書の違い"
  "report-minutes-unit1|report-minutes-structure|ライティング・文書作成/報告書・議事録の作成術/Unit 1 報告書の構造と書き方"
  "report-minutes-unit2|report-minutes-fact-opinion|ライティング・文書作成/報告書・議事録の作成術/Unit 2 事実と意見の明確な区別"
  "report-minutes-unit3|report-minutes-5w1h|ライティング・文書作成/報告書・議事録の作成術/Unit 3 議事録の取り方とまとめ方（5W1H）"
  "report-minutes-unit4|report-minutes-ai|ライティング・文書作成/報告書・議事録の作成術/Unit 4 AIを活用した議事録作成"
  ...
  "workskill01-unit1|workskill01-houkokusou|ワークスキル/ワークスキル実践講座Ⅰ（基礎編）/UNIT1_報連相の実践力を高める"
  "workskill01-unit2|workskill01-listening-speaking|ワークスキル/ワークスキル実践講座Ⅰ（基礎編）/UNIT2_「聴く力」と「伝える力」の基本"
  "workskill01-unit3|workskill01-priority|ワークスキル/ワークスキル実践講座Ⅰ（基礎編）/UNIT3_仕事の段取りと優先順位の付け方"
  "workskill01-unit4|workskill01-mistakes|ワークスキル/ワークスキル実践講座Ⅰ（基礎編）/UNIT4_ミスの防ぎ方とリカバリーの技術"
  "workskill01-unit5|workskill01-stress|ワークスキル/ワークスキル実践講座Ⅰ（基礎編）/UNIT5_新しい環境でのストレスマネジメント"
  "workskill01-unit6|workskill01-workplace-culture|ワークスキル/ワークスキル実践講座Ⅰ（基礎編）/UNIT6_職場のルール・文化を読み解く力"
  "workskill01-unit7|workskill01-time-management|ワークスキル/ワークスキル実践講座Ⅰ（基礎編）/UNIT7_時間管理と生活リズムの整え方"
  "workskill01-unit8|workskill01-trust-growth|ワークスキル/ワークスキル実践講座Ⅰ（基礎編）/UNIT8_信頼関係の構築と自己成長の振り返り"
  "workskill02-unit1|workskill02-motivation|ワークスキル/ワークスキル実践講座Ⅱ（実践編）/UNIT1_モチベーションの自己管理術"
  "workskill02-unit2|workskill02-professional|ワークスキル/ワークスキル実践講座Ⅱ（実践編）/UNIT2_仕事への向き合い方とプロ意識"
  "workskill02-unit3|workskill02-collaboration|ワークスキル/ワークスキル実践講座Ⅱ（実践編）/UNIT3_上司・同僚との効果的な連携術"
  "workskill02-unit4|workskill02-ownership|ワークスキル/ワークスキル実践講座Ⅱ（実践編）/UNIT4_当事者意識と_自分ごと化_する力"
  "workskill02-unit5|workskill02-problem-solving|ワークスキル/ワークスキル実践講座Ⅱ（実践編）/UNIT5_問題発見力と改善提案の技術"
  "workskill02-unit6|workskill02-foresight|ワークスキル/ワークスキル実践講座Ⅱ（実践編）/UNIT6_先読み力と_気づく力_を鍛える"
  "workskill02-unit7|workskill02-quality-productivity|ワークスキル/ワークスキル実践講座Ⅱ（実践編）/UNIT7_業務品質と生産性の向上"
  "workskill02-unit8|workskill02-team-contribution|ワークスキル/ワークスキル実践講座Ⅱ（実践編）/UNIT8_チームへの貢献と「期待以上」の仕事術"
  "workskill03-unit1|workskill03-mindset|ワークスキル/ワークスキル実践講座Ⅲ（自律編）/UNIT1_主体的に働くマインドセット"
  "workskill03-unit2|workskill03-learning|ワークスキル/ワークスキル実践講座Ⅲ（自律編）/UNIT2_学び続ける力：インプットとアウトプットの技術"
  "workskill03-unit3|workskill03-portable-skills|ワークスキル/ワークスキル実践講座Ⅲ（自律編）/UNIT3_どこでも通用するポータブルスキル"
  "workskill03-unit4|workskill03-influence|ワークスキル/ワークスキル実践講座Ⅲ（自律編）/UNIT4_積極性と周囲に良い影響を与える力"
  "workskill03-unit5|workskill03-career|ワークスキル/ワークスキル実践講座Ⅲ（自律編）/UNIT5_キャリア自律と市場価値の高め方"
  "workskill03-unit6|workskill03-network|ワークスキル/ワークスキル実践講座Ⅲ（自律編）/UNIT6_人脈と信頼ネットワークの築き方"
  "workskill03-unit7|workskill03-perseverance|ワークスキル/ワークスキル実践講座Ⅲ（自律編）/UNIT7_やり切る力と挑戦を続ける強さ"
  "workskill03-unit8|workskill03-growth-habits|ワークスキル/ワークスキル実践講座Ⅲ（自律編）/UNIT8_成長を加速させる習慣と未来への一歩"
)
